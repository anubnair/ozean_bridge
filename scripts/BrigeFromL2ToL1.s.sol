...
//        /****************************  MINT L1 ************************************/
//        // Mint L2 token (this can be removed, as it is preminted
//        uint256 amount = 1 * 10**18;
//        InterfaceL2Token(l2TokenAddress).mint(msg.sender, amount);
//        console.log("L2 Token minted:");
//
//        /****************************  approve bridge to spend L1 token ************************************/
//        IERC20(l2TokenAddress).approve(l2TokenAddress, amount);
